...
console.log("CONNECTING Hinata-Bot-MD BOT🧬...");
...
console.log('Hinata-Bot-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ʜɪɴᴀᴛᴀ-ʙᴏᴛ ᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ 𝙰𝙺𝙰𝚂𝙷𝙸 𝚂𝙰𝚂𝙰𝙺𝙸✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ʜɪɴᴀᴛᴀ-ʙᴏᴛ❁*
...
*╭⊱✫🔮 HINATA-BOT-MD🔮✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *Hinata-Bot-MD*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *NAOFUMI-SAMA*
*│✫➠ - 🌐URL:* *https://github.com/Iwantani-Naofumi/Hinata-Bot-MD*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/1fwlq02.jpeg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("242067274660")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("242067274660")){
...
app.get("/", (req, res) => {
res.send("HEY, Hinata-Bot-MD STARTED ✅");
});
